"""
SMS Transaction Sync Job Model for tracking SMS fetch and parse progress.
"""
...
class JobStatus(str, enum.Enum):
    """Status of SMS transaction sync job"""
    PENDING = "pending"
...
class SmsTransactionSyncJob(Base):
    """Model for tracking SMS transaction sync jobs"""
    __tablename__ = "sms_transaction_sync_jobs"
    ...
    total_sms = Column(Integer, default=0, nullable=False)
    processed_sms = Column(Integer, default=0, nullable=False)
    parsed_transactions = Column(Integer, default=0, nullable=False)
    failed_sms = Column(Integer, default=0, nullable=False)
